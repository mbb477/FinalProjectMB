...
Similarly, vegetable consumption does not appear to be an important variable for diabetes classification, with proportions for no fruit eaten for diabetics and non-diabetics being 0.18 and 0.24 respectdively.
...
The AnyHealthcare variable is similar in proportion for those who did not have healthcare at 0.04 and 0.05 for diabetics and non-diabetics respectively. This variable will be excluded from model fitting.
...
The contingency table for DiffWalk is below. For individuals with diabetes, the proportion of those who responded yes to difficulty walking or climbing stairs is 0.371 compared to that of those who wiithout diabetes, 0.135. This variable may be important for predicting diabetes and will be included in model fitting.
...
Similar to HighChol, HighBP was more commone among diabetics than non-diabetics, with proportions off 0.75 and 0.38, respectively. High blood pressure often occurs in conjunction with diabetes as part of metabolic syndrome and so will be included in the model fitting.
